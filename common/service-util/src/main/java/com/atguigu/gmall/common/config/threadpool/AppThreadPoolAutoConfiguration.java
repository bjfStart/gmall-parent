...
public class AppThreadPoolAutoConfiguration {
    ...
    public ThreadPoolExecutor coreExecutor(){
        ...
        //数组与链表 ？ --检索、插入
        //数组是连续空间，链表不连续（利用碎片空间）
        /**
         * int corePoolSize : 核心线程池数 ： cpu核心数 4
        ...
        ThreadPoolExecutor executor = new ThreadPoolExecutor(
                ...
                TimeUnit.SECONDS,
                new LinkedBlockingQueue(appThreadPoolProperties.getQueueSize()), //队列的大小由项目最终能占的最大内存决定
                new ThreadFactory() {
                    int i = 0; //记录线程自增id
                    @Override
