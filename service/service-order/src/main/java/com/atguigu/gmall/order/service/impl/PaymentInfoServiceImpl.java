...
public class PaymentInfoServiceImpl extends ServiceImpl<PaymentInfoMapper, PaymentInfo>
    ...
    public PaymentInfo savePaymentInfo(Map<String, String> map) {
        ...
        PaymentInfo one = getOne(new LambdaUpdateWrapper<PaymentInfo>()
        ...
        //根据对外交易号和用户id获取订单信息
        OrderInfo orderInfo = orderInfoService.getOrderInfoByOutTradeNoAndUserId(outTradeNo,paymentInfo.getUserId());
