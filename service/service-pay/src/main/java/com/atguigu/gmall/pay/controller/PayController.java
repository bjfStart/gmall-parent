...
/**
 * eoawmg6676@sandbox.com
 * @author feng
 * @create 2022-09-16 20:47
 */
@Slf4j
...
public class PayController {
    ...
    /**
     * http://api.gmall.com/api/payment/alipay/submit/777630655155535872
     * 跳到 支付宝的二维码收银台
     * @param orderId
     * @return
     */
     ...
     * 支付成功：同步跳转
     * 跳到支付成功页：
     * 支付成功以后，支付宝命令浏览器来到 http://gmall.com/api/payment/paysuccess
     * @return
     */
